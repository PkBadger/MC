...
<!-- Generator: Adobe Illustrator 19.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 1920 1110" style="enable-background:new 0 0 1920 1110;" xml:space="preserve">
        ...
        <path class="st0 dis"id="dis10" onclick="chooseD(this.id);" d="M824.2,598.9c5.2-1.8,10.5-3.6,15.7-5.4c0.1-0.1,0.3-0.2,0.4-0.2c4.8-2.3,9.5-5,14.6-6.6
        ...
        <path class="st0 dis"id="dis2" onclick="chooseD(this.id);" d="M692,318c9.5-3.8,17.7-9.6,25.3-16.3c0.9-0.8,1.2-2.6,1.3-4c0.7-14.6,1.4-29.3,1.9-43.9
        ...
        <path class="st0 dis" id="dis5" onclick="chooseD(this.id);" d="M1153.7,262.7c0.8,5.1,1.7,10.5,2.6,15.9c0.1,0.8,0.5,1.8,1.1,2.1c10.5,5.6,15,16.4,22,25
        ...
        <path class="st0 dis" id="dis4" onclick="chooseD(this.id);" d="M1050.6,237.3c0.7-0.3,1.9-1.1,3.1-1.1c9.6-0.5,14.4-6.7,18.1-14.6c2.4-5.1,4.1-5.5,8.9-2.7
        ...
        <path class="st0 dis" id="dis7" onclick="chooseD(this.id);" d="M1085.6,385.1c-0.9-4.8-2.1-8.6-2.1-12.5c-0.1-6.2-0.4-12.7,1.4-18.5c1.5-4.9,0.8-8.9-0.7-13.1
        ...
        <path class="st0 dis"id="dis6" onclick="chooseD(this.id);" d="M1107,300.9c0,6.2,0,12.3,0,18.5c0,4.5-2.1,6.1-6.6,6.9c-5.8,1-11.7,2.7-17,5.3c-5.6,2.7-6.6,2.9-9.6-2.2
        ...
        <path class="st0 dis" id="dis8" onclick="chooseD(this.id);" d="M1144,353.3c3.6-8,3.5-7.7,12-5.5c6.7,1.8,13.5,3,20.3,3.9c4.5,0.6,7.2,2.5,9.6,6.5
        ...
        <path class="st0 dis" id="dis9" onclick="chooseD(this.id);" d="M1167.9,389.9c0,2.3,0.3,4.7-0.1,7c-0.3,1.7-1,4.5-2,4.7c-6.5,1.4-7.7,8-11.9,11.5c-1.2,1-3.6,1.8-4.7,1.3
        ...
        <path class="st0 dis"id="dis3" onclick="chooseD(this.id);" d="M1030.1,223.9c5.8,2.6,11.1,4.7,16.1,7.4c1.1,0.6,1.8,3.3,1.5,4.8c-2,9-4.3,18-6.5,26.9
            ...
            <text x="815" y="367" fill="black" class="textg">Distrito 2</text>
            <text x="815" y="767" fill="black" class="textg">Distrito 10</text>
            <text x="1180" y="400" fill="black" class="text">8</text>
            <text x="1140" y="400" fill="black" class="text">9</text>
            <text x="1100" y="365" fill="black" class="text">7</text>
            <text x="1080" y="315" fill="black" class="text">6</text>
            <text x="1070" y="265" fill="black" class="text">4</text>
            <text x="1020" y="260" fill="black" class="text">3</text>
            <text x="1140" y="315" fill="black" class="text">5</text>
            <rect x="1100" y="100" width="20" height="20" style="fill:#f88d1e;stroke:#000000;stroke-width:1;stroke-opacity:0.9" />
    <text x="1130" y="115" fill="black" class="textch">Diputado Masculino</text>
    <rect x="1100" y="130" width="20" height="20" style="fill:#fb98b0;stroke:#000000;stroke-width:1;stroke-opacity:0.9" />
    <text x="1130" y="145" fill="black" class="textch">Diputada Femenina</text>
    <rect x="1100" y="160" width="20" height="20" style="fill:#ccffff;stroke:#000000;stroke-width:1;stroke-opacity:0.9" />
    <text x="1130" y="175" fill="black" class="textch">Faltan Datos</text>
              </svg>
    ...
    <script src="JS/modal.js"></script>
        ...
        <div id="Modal" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
          ...
          <div class="small-6 columns">
            ...
            <div class="small-6 columns">
                <a onclick="planillaJuarez()" class="button"style="width:100%;" >Planilla de Juarez</a>
            </div>   
          <div class="small-6 columns small-offset-3 columns">
        ...
        <script src="JS/getCandidatos.js"></script>
         <div id="myModalA" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
          ...
          <div>
            ...
            <div class="row">
                <div class="small-6 columns" >
                    <button class="button" id="CrearP"style="width:100%;" onclick="modalAyuntamientos('Juarez')">Crear Planilla</button>
                </div>
                <div class="small-6 columns">
                    <button style="width:100%;"id="CrearR" class="button" onclick="modalRegidores('Juarez')">Agregar Regidores</button>
                </div>
            </div>
          </div>
          <a class="close-reveal-modal" aria-label="Close">&#215;</a>
