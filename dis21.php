...
<g id="dis21">
	<path id="Satevo" class="st0"onclick="modal(this.id);" d="M460.2,128.7h-0.5L457,125l-4.7,2.3c0.1,0.6,0.2,1.1,0.3,1.7c0.2,1.1,0.1,1.9-0.2,2.5
	...
	<path id="ValleDeZaragoza" class="st0"onclick="modal(this.id);" d="M481.7,241.7l0.4,0.8c1,0.5,2,0.5,2.8,0.2s1.3-0.7,1.6-0.9c0.3-0.3,0.7,0.3,1.3,0.8
	...
	<path id="SantaIsabel" class="st0"onclick="modal(this.id);" d="M424.5,83.2c0.5,0.7,0.9,1.5,1.6,1.9c1.5,0.7,2.3,1.5,3.6,2.9c1,1,2,1.6,3.2,2.8
	...
	<path id="BelisarioDominguez" class="st0"onclick="modal(this.id);" d="M442.1,113.6l-3.1,2.7l-0.4,4l-7.3-0.4l-4.9-3.6l-5.3,6.9l5.3,5.7l-7.7,8.1l-6.5-7.3l0.4,12.6
	...
	<path id="GranMorelos" class="st0"onclick="modal(this.id);" d="M409.2,89l0.3,0.2c0.1,0.5,0.7,2.9,0.4,3.2c-0.3,0.3-0.7,0.7-0.9,1.1c-0.3,0.4-0.4,0.9-0.3,1.3
	...
	<path id="SanFcoDeBorja" class="st0" onclick="modal(this.id);"d="M371.3,137.8l-0.2,0.3c0,0.1,0.4,1.2,0.4,1.2c0.2,0.2,0.9,0.9,1.5,1.7c0.7,0.8,1.3,1.6,1.3,2
	...
	<path id="Nonoava" class="st0" onclick="modal(this.id);"d="M369,240.5l0.4,3.6l-5.7,0.4l11.8,7.3l5.3,22.3l26.3,4.8c1.4-0.7,2.3-1.9,4-2.8
	...
	<path id="Matamoros" class="st0"onclick="modal(this.id);" d="M595.3,344.5l-0.1-0.4c-1-0.4-2-0.6-2.6-1c-0.3-0.2-0.5-0.5-0.7-0.8c-0.1-0.4-0.1-0.8,0-1.4
	...
	<path id="Parral" onclick="modal(this.id);"class="st0" d="M509.4,268.9l0.4,0.4c1.1,1.1,2.3,1.5,3.2,2.4c1.1,1.1,1.1,1.3,0.8,1.5s-1.1,0.4-1.6,1.4
	...
	<path id="SantaBarbara"onclick="modal(this.id);" class="st0" d="M532.5,316.2l-0.4,0.3c-0.1,0.5,0.1,1.1,0.2,1.6c0.1,0.5,0.2,1-0.2,1.2
		...
		z"/>
	<path id="SanFcoDelOro"onclick="modal(this.id);" class="st0" d="M509.2,305.9l-0.6,0.9c0.1,0.6-0.3,1.6-0.8,2.7s-1,2.2-1.2,3c-0.1,0.6-0.7,1.2-1.3,1.8
	...
	<path id="Huejotitan"onclick="modal(this.id);" class="st0" d="M485.5,262.1l-0.4,0.3c-0.1,0.4-0.4,0.8-0.4,1.2c0,1-0.2,2-0.4,2.9c-0.1,0.9-0.2,1.8,0.4,2.8
	...
	<path id="Rosario" onclick="modal(this.id);" class="st0" d="M415.5,274L415.5,274c0.1,0.1,0.4,0.6,0.7,1.2c0.3,0.6,0.5,1.2,0.2,1.3
	...
	<path id="ElTule" onclick="modal(this.id);" class="st0" d="M426.6,284.8L426.6,284.8c0.1,0.8,0.2,1.4,0.1,1.9c-0.1,0.6-0.3,1.1-0.6,1.8s-0.5,1.1-0.4,1.3
...
<text x="540" y="353" fill="black" class="textxs">Matamoros</text>
<text x="510" y="293" fill="black" class="textxs">Hgo. del Parral</text>
<text x="500" y="233" fill="black" class="textxs">V. de Zaragoza</text>
<text x="465" y="183" fill="black" class="textch">Satevo</text>
<text x="410" y="153" fill="black" class="textxs">Belisario</text>
<text x="410" y="163" fill="black" class="textxs">Dominguez</text>
<text x="410" y="103" fill="black" class="textxs">Gran</text>
<text x="410" y="113" fill="black" class="textxs">Morelos</text>
<text x="445" y="93" fill="black" class="textxs">Santa</text>
<text x="445" y="103" fill="black" class="textxs">Isabel</text>
<text x="365" y="157" fill="black" class="textxs">San Fco.</text>
<text x="365" y="167" fill="black" class="textxs">de Borja</text>
<text x="385" y="245" fill="black" class="textxs">Nonoava</text>
<text x="435" y="267" fill="black" class="textxs">Rosario</text>
<text x="435" y="305" fill="black" class="textxs">El tule</text>
<text x="470" y="305" fill="black" class="textxs">Huejotitan</text>
<text x="440" y="335" fill="black" class="textxs">San fco. del oro</text>
<text x="467" y="353" fill="black" class="textxs">Santa Barbara</text>
 ...
 <div id="myModal" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
  ...
  <script>
    ...
    <script type="text/javascript">
      var municipios = ["Matamoros","Parral","ValleDeZaragoza","Satevo","BelisarioDominguez","GranMorelos","SantaIsabel","SanFcoDeBorja","Nonoava","Rosario","ElTule","Huejotitan","SanFcoDelOro","SantaBarbara"];
    </script>
