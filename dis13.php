...
<style type="text/css">
	...
	.st1{fill:#8FD4EB;stroke:#565656;stroke-width:0.7;}
</style>
<g id="dis13">
	<path id="Namiquipa" onclick="modal(this.id);" class="st0" d="M506.3,89l1.3,10.5l-5.6,3.3l8.9,7.5l-1.4,4.7l-2.8,2.4l4.7,3.8l-4.7,6.1l6.6,8l6.6-2.4
	...
	<path id="Bachiniva" onclick="modal(this.id);" class="st1" d="M525.8,152.1h0.3c0.5,0,1.7,0,2.9,0s2.3,0.1,2.4,0.4c0.4,0.9,1.3,1.4,2.2,1.8
	...
	<path id="Cusihuiriachi" onclick="modal(this.id);" class="st1" d="M582.2,217.5c-0.1,0.3,0,0.4-0.3,0.9c-0.3,0.7-0.7,1.3-1.1,1.8c-0.4,0.5-1,1-1.8,1.4
	...
	<path id="Bocoyna"onclick="modal(this.id);" class="st1" d="M478.3,266.9l-5.7,4.1l4.9,7.3l-5.7,6.1l2.4,7.3l-4,4.8l2,6.5l-0.4,11.3l-3.6,9.7
	...
	<path id="Maguarichi" onclick="modal(this.id);" class="st1" d="M472.1,285.3l-0.7-0.1c-0.4-0.1-1.4-0.6-2-1.4c-0.3-0.4-0.5-0.8-0.6-1.3c0-0.5,0.1-0.9,0.6-1.4
	...
	<path id="Guazapares" onclick="modal(this.id);" class="st1" d="M389,428.1l0.4-0.4c1.5-0.5,2.3-1,2.3-1.4c0.1-0.5-0.6-1-1.8-1.7c-0.3-0.1-0.3-0.4-0.2-0.7
	...
	<path id="Chinipas" onclick="modal(this.id);" class="st1" d="M384.4,426.6l-0.8-2.5c-0.3-1.3-1-2-1.4-2.7c-0.2-0.3-0.3-0.7-0.3-1c0.1-0.3,0.3-0.8,0.7-1.2
	...
	<path id="Uruachi" onclick="modal(this.id);" class="st1" d="M346.1,338.2L346.1,338.2c0.2-0.3,0.6-1.2,0.9-1.8c0.2-0.4,1.9-4.7,2.2-4.5
	...
	<path id="Moris" onclick="modal(this.id);"  class="st1" d="M313.2,279.6L313.2,279.6l5.9-4.5l-4.5-5.4l4.5-6.2l9.3,4.4l3.6-1.3l6.2,4.9l17.3,9.3h6.7
	...
	<path id="Ocampo" onclick="modal(this.id);" class="st1" d="M386.3,220.9l-4.3,2v10.5c0,0.2,0.1,1.6,0,1.6c-1.4,0.7-2,0.9-1.9,1.1c0.1,0.2,0.6,0.6,1.1,1.7
	...
	<path id="Guerrero" onclick="modal(this.id);" class="st1" d="M436.2,224.9l-0.4,6.8l16.2,12.9l5.7-2l-0.8,6.5l6.5,5.3L461,258l8.9,0.4l3.2,3.6l4.9,1.2
	...
	<path id="Matachi" class="st1" onclick="modal(this.id);" d="M474.1,171.9l0.5,0.4l5.7-6.1l1.2,9.3l4.9-3.2l0.4-3.2l8.9-4l-3.2-7.7l9.7,4.8l0.8-4.4l6.1-8.5
	...
	<path id="Temosachic"onclick="modal(this.id);" class="st1" d="M380.9,216.2l0.7,0.2c0.4,0.4,0.4,0.8,1.2,1.2c0.8,0.4,2.7,3.1,3.2,3.2c1,0.3,2.6,0.6,4.2,1
...
<text x="330" y="255" fill="black" class="textch">Moris</text>
<text x="345" y="298" fill="black" class="textch">Uruachi</text>
<text x="348" y="340" fill="black" class="textxs">Chinipas</text>
<text x="387" y="360" fill="black" class="textxs">Guazapares</text>
<text x="427" y="300" fill="black" class="textxs">Maguarichi</text>
<text x="477" y="310" fill="black" class="textch">Bocoyna</text>
<text x="477" y="220" fill="black" class="textch">Guerrero</text>
<text x="473" y="150" fill="black" class="textxs">Matachi</text>
<text x="531" y="145" fill="black" class="textxs">Bachiniva</text>
<text x="531" y="75" fill="black" class="textch">Namiquipa</text>
<text x="394" y="250" fill="black" class="textch">Ocampo</text>
<text x="384" y="200" fill="black" class="textch">Temosachic</text>
<text x="567" y="240" fill="black" class="textxs">Cusihuiriachi</text>
</svg>
...
<script type="text/javascript">
    	var municipios = ["Moris","Uruachi","Chinipas","Guazapares","Maguarichi","Bocoyna","Guerrero","Matachi","Bachiniva","Namiquipa","Ocampo","Temosachic","Cusihuiriachi"];
    </script>
